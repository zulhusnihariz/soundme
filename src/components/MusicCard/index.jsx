const MusicCard = ({ name, owner, description }) => {
  return (
    <>
      <a href="#" class="relative block overflow-hidden rounded-lg border border-gray-100 p-8">
        ...
        <div class="justify-between sm:flex">
          <div>
            ...
            <p class="mt-1 text-xs font-medium text-gray-600">By {owner}</p>
          </div>
        ...
        <div class="mt-4 sm:pr-8">
          <p class="text-sm text-gray-500">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. At velit illum provident a, ipsa maiores deleniti
